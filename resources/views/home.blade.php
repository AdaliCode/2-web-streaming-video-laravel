...
@section('title', 'Arix')
@section('container')
@include('partials.videoCoverHome', ['title' => 'Top 10', 'data' => $top10videos, 'overlayTextType' => 'rank', 'needCategorySubtitle' => true])
...
@include('partials.videoCoverHome', ['title' => 'Segera Tayang', 'data' => $comingSoon, 'overlayTextType' => 'timeReleaseOrSoon', 'needCategorySubtitle' => true])
